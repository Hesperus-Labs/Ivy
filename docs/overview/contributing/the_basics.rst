...
* Hesperus Ivy is installed inside the container with :code:`uv sync --python 3.12`
* The uv environment depends on the checked-in source tree, rather than creating a stale copy.
